...
<body>
    <div class=header>
        <a class = "a" href="index.php" ><h1>Harvesto Cart</h1></a>
    </div>
    ...
    <div class="container">
        <table>
            ...
            <tr class="total-row">
                ...
                <td><a onclick=clickOrder() href="../Home/web%20new%20page/home.html" class="btn" >Order</a></td>
            </tr>
        </table>
    </div>
    <div class="footer">
        &copy; Harvesto Store. All Rights Reserved. | Contact Us: +94 754005678
