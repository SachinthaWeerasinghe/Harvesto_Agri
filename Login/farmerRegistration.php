...
<html lang="en">
<head>
    <title>Harvesto Farmer Registration</title>
	<style>
...
<body>
    <center>
        <h1>Harvesto Farmer Registration</h1>
        <form action="FarmerdataInsertion.php" method="post" onsubmit="return validateForm()">
