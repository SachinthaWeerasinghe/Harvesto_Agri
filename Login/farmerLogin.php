...
<body>
	...
	<a href = "farmer_forgot_password.html"><input type="submit" value="forgot password?"></a>
	</div>
...
// Query the database
$sql = "SELECT * FROM farmer WHERE username = '$enteredUsername' AND password = '$enteredPassword'";
$result = $conn->query($sql);

if ($result->num_rows == 1) {
    // Valid login; redirect to the product page
    header("Location: ../Our Product Farmer/Our-Product.html"); 
